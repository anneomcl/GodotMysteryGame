...
const clues = [
	...
	#Scenario 0 facts	
	{ "id": "general1", "title": "Everyone who was in the kitchen from 4PM to 4:30PM is a suspect." },
	{ "id": "general2", "title": "Beatrice could have taken the cookies." },
	{ "id": "general3", "title": "Archie himself could have hidden the cookies between 4PM and 4:05PM, when he stepped out of the office." },
	{ "id": "general4", "title": "Andre could have taken the cookies." },
	
	{ "id": "general5", "title": "Someone could be trying to sabotage Andre with lemon fairies." },
	{ "id": "general6", "title": "Beatrice could be trying to sabotage Andre with lemon fairies." },

	{ "id": "library1", "title": "There are nefarious lemon fairies that are attracted by anything that looks, smells or tastes like lemons." },
	...
	{ "id": "A3", "title": "While taking a cookie, Andre saw Beatrice near the sink. She was still there when he left."},

	{ "id": "B1", "title": "Beatrice was in the break room at 4PM, washing her coffee mug in the sink." },
	{ "id": "B2", "title": "Andre arrived in the kitchen around 4PM. Beatrice left soon after, leaving him alone in the kitchen." },

	{ "id": "office1", "title" : "Lemon paraphernalia in A's desk" },
	{ "id": "office2", "title" : "Squash Squad Performance Report: 1) Andre, 2) XXX, 3) YYY, 4) Beatrice" },
]